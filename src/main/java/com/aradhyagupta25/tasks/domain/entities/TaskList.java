...
public class TaskList {
    ...
    @OneToMany(mappedBy = "taskList", cascade = {CascadeType.REMOVE, CascadeType.PERSIST})      // one task list for many tasks. if we remove a list, tasks in it will be removed too ( .REMOVE) . if we save a list, tasks in it will be saved too (.PERSIST). creating a BIDIRECTIONAL relationship with the task.
